...
const HOW_STEPS = [
  ...
  },
  {
    ...
    icon: "auto_awesome",
    title: "Create",
    body: "Approve delivery, release payout, and leave verified feedback that strengthens the creative's trust standing over time.",
  },
] as const;
...
function deriveTierSummary(artist: Artist): TierSummary {
  ...
  if (liveTier) {
    return {
      ...
      description:
        ...
        "Platform standing based on verified delivery, response quality, and completed projects.",
    };
  }
  ...
  return {
    ...
    name: "Launch Entry",
    description:
      "Newly surfaced profile building verified delivery history and trust signals through completed projects.",
  };
}
...
export default async function ArtistProfilePage({
  ...
  if (!artist && fallbackArtist) {
    ...
    previewMode = true;
    previewMessage =
      "This is a curated public preview while live creator onboarding expands. Project actions below will route you toward live discovery.";
  }
  ...
  const browseHref = artist.category?.slug
    ? `/explore?category=${encodeURIComponent(artist.category.slug)}`
    : "/explore";
  ...
  return (
    <main className={styles.page}>
      <section className={styles.cover}>
        ...
        <div className={styles.coverPortfolioStrip} aria-label="Featured portfolio work">
          {portfolioItems.slice(0, 3).map((item, index) => (
            <a
              key={item.id}
              href={item.href ?? "#portfolio"}
              className={styles.coverPortfolioItem}
              data-featured={index === 0}
              target={item.href ? "_blank" : undefined}
              rel={item.href ? "noreferrer" : undefined}
            >
              <span
                className={styles.coverPortfolioImage}
                style={
                  item.imageUrl
        ...
        <div className={styles.coverStatBar}>
          ...
          <div className={styles.coverStat}>
            ...
            <span className={styles.coverStatLabel}>Completed projects</span>
          </div>
          <div className={styles.coverStat}>
          ...
          <section id="overview" className={styles.profileSection}>
            ...
            <div className={styles.trustRow}>
              ...
              <span className={`${styles.trustBadge} ${styles.liveBadge}`}>
                {artist.isAvailable ? "◉ Accepting projects" : "○ Planning next availability"}
              </span>
            </div>
          ...
          <section id="portfolio" className={styles.profileSection}>
            ...
            <div className={styles.portfolioFilters}>
              {portfolioFilters.map((filter) => {
                ...
                const href =
                  filterSlug === "all"
                    ? `/creatives/${artist.slug}#portfolio`
                    : `/creatives/${artist.slug}?portfolio=${encodeURIComponent(filterSlug)}#portfolio`;
                ...
                >
                  <div className={styles.reviewHeader}>
                    <div>
                      ...
                      <div className={styles.reviewMeta}>Client · Verified project</div>
                    </div>
          ...
          <section className={`${styles.sidebarCard} ${styles.bookingCard}`}>
            ...
            <div className={styles.sidebarEyebrow}>Ready to create?</div>
              <h2 className={styles.sidebarTitle}>
                {artist.id ? `Start with ${firstName}` : "Explore this style"}
              </h2>
            </div>
                ...
                <span className={styles.availabilityText}>
                  {artist.availabilitySummary?.trim() ||
                    (artist.isAvailable
                      ...
                      : "Limited availability — planning next projects")}
                </span>
              </div>
            ...
            <div className={styles.sidebarCardBody}>
              ...
              <div className={styles.sidebarBrowseWrap}>
                <Link href={browseHref} className={styles.sidebarBrowseLink}>
                  Browse more {artist.category?.name?.toLowerCase() ?? "creatives"} →
                </Link>
              </div>
            </div>
          </section>
      ...
      <section className={styles.howMini}>
        <div className={styles.howMiniLabel}>The project flow</div>
      ...
      <section className={styles.bottomCta}>
        ...
        <div className={styles.bottomCtaInner}>
          ...
          <p className={styles.bottomCtaSubcopy}>
            {artist.id
              ? "Send a project request or start with a message. Payments stay protected on-platform until you approve delivery."
