...
export default function ProjectDetailPage() {
  ...
  const runAction = async (
    ...
    if (onboardingLocked) {
      setError("Complete onboarding before updating project status.");
      return;
    }
    setActing(true);
    setError(null);
    try {
      ...
      if (err instanceof ApiError) {
        ...
        setError("Unable to update the project right now.");
      }
    } finally {
      setActing(false);
    }
  ...
  const openConversation = async () => {
    ...
    if (onboardingLocked) {
      setError("Complete onboarding before opening project messages.");
      return;
    }
  ...
  return (
    <main className={styles.page}>
      ...
      {loading ? <p className={styles.subtle}>Loading project...</p> : null}
        ...
        <section className={styles.layout}>
          <div className={styles.mainCard}>
            ...
            <div className={styles.grid}>
              ...
              <div>
                <p className={styles.label}>Creative</p>
            ...
            {canVerifyStartCode ? (
              <div className={styles.section}>
                ...
                <p className={styles.subtle}>
                  The creative must enter the client safety code before the project
                ...
                <div className={styles.inlineForm}>
                  ...
                  >
                    {verifyingCode ? "Verifying..." : "Start project"}
                  </button>
                </div>
              </div>
            ) : null}
            ...
            {booking.canReview ? (
              <div className={styles.section}>
                ...
                <p className={styles.subtle}>
                  This project is complete. Share feedback for the creative.
                </p>
          ...
          <aside className={styles.sidebar}>
            <div className={styles.sidebarCard}>
              ...
              {booking.verificationCode && booking.client.id === viewer?.id ? (
                <div className={styles.noteCard}>
                  Share this safety code with the creative at the start of the project:
            ...
            <div className={styles.sidebarCard}>
              <p className={styles.kicker}>Project value</p>
              <div className={styles.totalRow}>
